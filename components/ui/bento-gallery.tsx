...
> = ({ imageItems, title, description }) => {
  ...
  return (
    ...
    >
      ...
      {/* Grille responsive en lignes (plus besoin de drag) */}
        ...
        >
          {imageItems.map((item) => (
            <motion.div
              ...
              className={cn(
                "group relative flex cursor-pointer items-end overflow-hidden rounded-xl border bg-card p-4 shadow-sm transition-shadow duration-300 ease-in-out hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
                item.span,
              )}
